...
public class SplashEditorFrame extends javax.swing.JFrame implements Runnable {
    ...
    public static void ejecutar() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashEditorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashEditorFrame().setVisible(true);
            }
        });
    }   
    ...
    public void run() {        
        while ( tiempo != null){
            try {
                ...
                Logger.getLogger(SplashEditorFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }  
        tiempo = null;
    }                       
