...
:*========================================================================================== 
:*  22/abr/2020 Misael Adame         Agregar el botón que inicia la aplicación 
:*                                   PrismasConBeansApp y modificación del 
:*                                   prólogo
:*------------------------------------------------------------------------------------------*/
...
import prismas.beans.SplashPrismasConBeansFrame;
...
public class PrincipalFrame extends javax.swing.JFrame {
    ...
    public PrincipalFrame() {
        ...
        Icon prismas_beans = Imagenes.escalarImagen ( jbtnPrismasConBeansApp.getIcon (),
                                                      jbtnPrismasConBeansApp.getWidth (),
                                                      jbtnPrismasConBeansApp.getHeight () );
        ...
        jbtnPrismasConBeansApp.setIcon ( prismas_beans );
    }
    ...
    private void initComponents() {
        ...
        jbtnPrismasConBeansApp = new javax.swing.JButton();
        ...
        jbtnPrismasConBeansApp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/principal/iconos/icon_PrismasConBeansApp.jpg"))); // NOI18N
        jbtnPrismasConBeansApp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jbtnPrismasConBeansApp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnPrismasConBeansAppActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jbtnPrismasConBeansApp, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jbtnPrismasApp, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                    .addComponent(jbtnEditorApp, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
    ...
    private void jbtnPrismasConBeansAppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPrismasConBeansAppActionPerformed
        SplashPrismasConBeansFrame.ejecutar ();
        this.setVisible ( false );
    }//GEN-LAST:event_jbtnPrismasConBeansAppActionPerformed
    ...
    private javax.swing.JButton jbtnPrismasConBeansApp;
