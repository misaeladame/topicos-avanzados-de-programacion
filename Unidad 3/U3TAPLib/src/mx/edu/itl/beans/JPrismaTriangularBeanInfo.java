...
public class JPrismaTriangularBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mx.edu.itl.beans.JPrismaTriangular.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_cateto_a = 12;
    private static final int PROPERTY_cateto_b = 13;
    private static final int PROPERTY_catetoA = 14;
    private static final int PROPERTY_catetoB = 15;
    ...
    private static final int PROPERTY_imagenPrismaTriangularAjustado = 52;
    ...
    private static final int PROPERTY_leyendaAltura = 62;
    ...
    private static final int PROPERTY_prismaTriangular = 86;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", mx.edu.itl.beans.JPrismaTriangular.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", mx.edu.itl.beans.JPrismaTriangular.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", mx.edu.itl.beans.JPrismaTriangular.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", mx.edu.itl.beans.JPrismaTriangular.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_altura] = new PropertyDescriptor ( "altura", mx.edu.itl.beans.JPrismaTriangular.class, "getAltura", "setAltura" ); // NOI18N
            properties[PROPERTY_altura].setPreferred ( true );
            properties[PROPERTY_altura].setDisplayName ( "Valor Altura" );
            properties[PROPERTY_altura].setShortDescription ( "Determina el valor de la Altura del Prisma Triangular" );
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", mx.edu.itl.beans.JPrismaTriangular.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", mx.edu.itl.beans.JPrismaTriangular.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", mx.edu.itl.beans.JPrismaTriangular.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", mx.edu.itl.beans.JPrismaTriangular.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", mx.edu.itl.beans.JPrismaTriangular.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", mx.edu.itl.beans.JPrismaTriangular.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", mx.edu.itl.beans.JPrismaTriangular.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_cateto_a] = new PropertyDescriptor ( "cateto_a", mx.edu.itl.beans.JPrismaTriangular.class, "getCateto_a", "setCateto_a" ); // NOI18N
            properties[PROPERTY_cateto_a].setPreferred ( true );
            properties[PROPERTY_cateto_a].setDisplayName ( "Valor Cateto A" );
            properties[PROPERTY_cateto_a].setShortDescription ( "Determina el valor del Cateto A" );
            properties[PROPERTY_cateto_b] = new PropertyDescriptor ( "cateto_b", mx.edu.itl.beans.JPrismaTriangular.class, "getCateto_b", "setCateto_b" ); // NOI18N
            properties[PROPERTY_cateto_b].setPreferred ( true );
            properties[PROPERTY_cateto_b].setDisplayName ( "Valor Cateto B" );
            properties[PROPERTY_cateto_b].setShortDescription ( "Determina el Valor del Cateto B" );
            properties[PROPERTY_catetoA] = new PropertyDescriptor ( "catetoA", mx.edu.itl.beans.JPrismaTriangular.class, "getCatetoA", "setCatetoA" ); // NOI18N
            properties[PROPERTY_catetoA].setPreferred ( true );
            properties[PROPERTY_catetoA].setDisplayName ( "Leyenda Cateto A" );
            properties[PROPERTY_catetoA].setShortDescription ( "Permite modificar la Leyenda del Cateto A" );
            properties[PROPERTY_catetoB] = new PropertyDescriptor ( "catetoB", mx.edu.itl.beans.JPrismaTriangular.class, "getCatetoB", "setCatetoB" ); // NOI18N
            properties[PROPERTY_catetoB].setPreferred ( true );
            properties[PROPERTY_catetoB].setDisplayName ( "Leyenda Cateto B" );
            properties[PROPERTY_catetoB].setShortDescription ( "Prmite modificar la Leyenda del Cateto B" );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", mx.edu.itl.beans.JPrismaTriangular.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", mx.edu.itl.beans.JPrismaTriangular.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", mx.edu.itl.beans.JPrismaTriangular.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", mx.edu.itl.beans.JPrismaTriangular.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", mx.edu.itl.beans.JPrismaTriangular.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", mx.edu.itl.beans.JPrismaTriangular.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", mx.edu.itl.beans.JPrismaTriangular.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners
class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", mx.edu.itl.beans.JPrismaTriangular.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", mx.edu.itl.beans.JPrismaTriangular.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", mx.edu.itl.beans.JPrismaTriangular.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", mx.edu.itl.beans.JPrismaTriangular.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", mx.edu.itl.beans.JPrismaTriangular.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", mx.edu.itl.beans.JPrismaTriangular.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", mx.edu.itl.beans.JPrismaTriangular.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_prismaTriangular] = new PropertyDescriptor ( "prismaTriangular", mx.edu.itl.beans.JPrismaTriangular.class, "getPrismaTriangular", "setPrismaTriangular" ); // NOI18N
            properties[PROPERTY_prismaTriangular].setPreferred ( true );
            properties[PROPERTY_prismaTriangular].setDisplayName ( "Imagen Prisma Triangular" );
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", mx.edu.itl.beans.JPrismaTriangular.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", mx.edu.itl.beans.JPrismaTriangular.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", mx.edu.itl.beans.JPrismaTriangular.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", mx.edu.itl.beans.JPrismaTriangular.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", mx.edu.itl.beans.JPrismaTriangular.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", mx.edu.itl.beans.JPrismaTriangular.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", mx.edu.itl.beans.JPrismaTriangular.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", mx.edu.itl.beans.JPrismaTriangular.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", mx.edu.itl.beans.JPrismaTriangular.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", mx.edu.itl.beans.JPrismaTriangular.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", mx.edu.itl.beans.JPrismaTriangular.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", mx.edu.itl.beans.JPrismaTriangular.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", mx.edu.itl.beans.JPrismaTriangular.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", mx.edu.itl.beans.JPrismaTriangular.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", mx.edu.itl.beans.JPrismaTriangular.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", mx.edu.itl.beans.JPrismaTriangular.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", mx.edu.itl.beans.JPrismaTriangular.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mx.edu.itl.beans.JPrismaTriangular.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", mx.edu.itl.beans.JPrismaTriangular.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", mx.edu.itl.beans.JPrismaTriangular.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", mx.edu.itl.beans.JPrismaTriangular.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", mx.edu.itl.beans.JPrismaTriangular.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaTriangular.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_addJPrismaTriangularListener7 = 7;
    ...
    private static final int METHOD_fireJPrismaTriangularEvent36 = 36;
    ...
    private static final int METHOD_removeJPrismaTriangularListener116 = 116;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addJPrismaTriangularListener7] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("addJPrismaTriangularListener", new Class[] {mx.edu.itl.eventos.JValoresPrismasListener.class})); // NOI18N
            methods[METHOD_addJPrismaTriangularListener7].setDisplayName ( "" );
            ...
            methods[METHOD_areaBase11] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("areaBase", new Class[] {})); // NOI18N
            methods[METHOD_areaBase11].setDisplayName ( "" );
            methods[METHOD_areaLateral12] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("areaLateral", new Class[] {})); // NOI18N
            methods[METHOD_areaLateral12].setDisplayName ( "" );
            methods[METHOD_areaTotal13] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("areaTotal", new Class[] {})); // NOI18N
            ...
            methods[METHOD_fireJPrismaTriangularEvent36] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("fireJPrismaTriangularEvent", new Class[] {mx.edu.itl.eventos.JPrismaTriangularEvent.class})); // NOI18N
            methods[METHOD_fireJPrismaTriangularEvent36].setDisplayName ( "" );
            ...
            methods[METHOD_removeJPrismaTriangularListener116] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("removeJPrismaTriangularListener", new Class[] {mx.edu.itl.eventos.JValoresPrismasListener.class})); // NOI18N
            methods[METHOD_removeJPrismaTriangularListener116].setDisplayName ( "" );
            ...
            methods[METHOD_update147] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("update", new Class[] {})); // NOI18N
            ...
            methods[METHOD_volumen150] = new MethodDescriptor(mx.edu.itl.beans.JPrismaTriangular.class.getMethod("volumen", new Class[] {})); // NOI18N
    ...
    private static String iconNameC16 = "/mx/edu/itl/util/PrismaTriangular_icon.png";//GEN-BEGIN:Icons
