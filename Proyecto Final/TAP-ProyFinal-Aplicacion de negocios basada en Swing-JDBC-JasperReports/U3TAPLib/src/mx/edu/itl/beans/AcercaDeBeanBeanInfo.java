...
:*
:*                           BeanInfo de un Acerca de..
:*        
:*  Archivo     : AcercaDeBeanBeanInfo.java
...
public class AcercaDeBeanBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mx.edu.itl.beans.AcercaDeBean.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_campus = 14;
    ...
    private static final int PROPERTY_control1 = 24;
    private static final int PROPERTY_control2 = 25;
    private static final int PROPERTY_control3 = 26;
    ...
    private static final int PROPERTY_derechosReservados = 30;
    private static final int PROPERTY_desarrolladoPor = 31;
    ...
    private static final int PROPERTY_institucion = 64;
    ...
    private static final int PROPERTY_logo1 = 71;
    private static final int PROPERTY_logo1Ajustado = 72;
    private static final int PROPERTY_logo2 = 73;
    private static final int PROPERTY_logo2Ajustado = 74;
    private static final int PROPERTY_managingFocus = 75;
    private static final int PROPERTY_materia = 76;
    ...
    private static final int PROPERTY_nombreApp = 87;
    ...
    private static final int PROPERTY_versionApp = 112;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", mx.edu.itl.beans.AcercaDeBean.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", mx.edu.itl.beans.AcercaDeBean.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", mx.edu.itl.beans.AcercaDeBean.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", mx.edu.itl.beans.AcercaDeBean.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", mx.edu.itl.beans.AcercaDeBean.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autor1] = new PropertyDescriptor ( "autor1", mx.edu.itl.beans.AcercaDeBean.class, "getAutor1", "setAutor1" ); // NOI18N
            properties[PROPERTY_autor1].setPreferred ( true );
            properties[PROPERTY_autor2] = new PropertyDescriptor ( "autor2", mx.edu.itl.beans.AcercaDeBean.class, "getAutor2", "setAutor2" ); // NOI18N
            properties[PROPERTY_autor2].setPreferred ( true );
            properties[PROPERTY_autor3] = new PropertyDescriptor ( "autor3", mx.edu.itl.beans.AcercaDeBean.class, "getAutor3", "setAutor3" ); // NOI18N
            properties[PROPERTY_autor3].setPreferred ( true );
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", mx.edu.itl.beans.AcercaDeBean.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", mx.edu.itl.beans.AcercaDeBean.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", mx.edu.itl.beans.AcercaDeBean.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", mx.edu.itl.beans.AcercaDeBean.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", mx.edu.itl.beans.AcercaDeBean.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", mx.edu.itl.beans.AcercaDeBean.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_campus] = new PropertyDescriptor ( "campus", mx.edu.itl.beans.AcercaDeBean.class, "getCampus", "setCampus" ); // NOI18N
            properties[PROPERTY_campus].setPreferred ( true );
            properties[PROPERTY_carrera] = new PropertyDescriptor ( "carrera", mx.edu.itl.beans.AcercaDeBean.class, "getCarrera", "setCarrera" ); // NOI18N
            properties[PROPERTY_carrera].setPreferred ( true );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", mx.edu.itl.beans.AcercaDeBean.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", mx.edu.itl.beans.AcercaDeBean.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", mx.edu.itl.beans.AcercaDeBean.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", mx.edu.itl.beans.AcercaDeBean.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", mx.edu.itl.beans.AcercaDeBean.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", mx.edu.itl.beans.AcercaDeBean.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", mx.edu.itl.beans.AcercaDeBean.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", mx.edu.itl.beans.AcercaDeBean.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_control1] = new PropertyDescriptor ( "control1", mx.edu.itl.beans.AcercaDeBean.class, "getControl1", "setControl1" ); // NOI18N
            properties[PROPERTY_control1].setPreferred ( true );
            properties[PROPERTY_control2] = new PropertyDescriptor ( "control2", mx.edu.itl.beans.AcercaDeBean.class, "getControl2", "setControl2" ); // NOI18N
            properties[PROPERTY_control2].setPreferred ( true );
            properties[PROPERTY_control3] = new PropertyDescriptor ( "control3", mx.edu.itl.beans.AcercaDeBean.class, "getControl3", "setControl3" ); // NOI18N
            properties[PROPERTY_control3].setPreferred ( true );
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", mx.edu.itl.beans.AcercaDeBean.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", mx.edu.itl.beans.AcercaDeBean.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", mx.edu.itl.beans.AcercaDeBean.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_derechosReservados] = new PropertyDescriptor ( "derechosReservados", mx.edu.itl.beans.AcercaDeBean.class, "getDerechosReservados", "setDerechosReservados" ); // NOI18N
            properties[PROPERTY_derechosReservados].setPreferred ( true );
            properties[PROPERTY_desarrolladoPor] = new PropertyDescriptor ( "desarrolladoPor", mx.edu.itl.beans.AcercaDeBean.class, "getDesarrolladoPor", "setDesarrolladoPor" ); // NOI18N
            properties[PROPERTY_desarrolladoPor].setPreferred ( true );
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", mx.edu.itl.beans.AcercaDeBean.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", mx.edu.itl.beans.AcercaDeBean.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", mx.edu.itl.beans.AcercaDeBean.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", mx.edu.itl.beans.AcercaDeBean.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", mx.edu.itl.beans.AcercaDeBean.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", mx.edu.itl.beans.AcercaDeBean.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", mx.edu.itl.beans.AcercaDeBean.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", mx.edu.itl.beans.AcercaDeBean.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", mx.edu.itl.beans.AcercaDeBean.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", mx.edu.itl.beans.AcercaDeBean.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", mx.edu.itl.beans.AcercaDeBean.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", mx.edu.itl.beans.AcercaDeBean.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", mx.edu.itl.beans.AcercaDeBean.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", mx.edu.itl.beans.AcercaDeBean.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", mx.edu.itl.beans.AcercaDeBean.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", mx.edu.itl.beans.AcercaDeBean.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", mx.edu.itl.beans.AcercaDeBean.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", mx.edu.itl.beans.AcercaDeBean.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", mx.edu.itl.beans.AcercaDeBean.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", mx.edu.itl.beans.AcercaDeBean.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", mx.edu.itl.beans.AcercaDeBean.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", mx.edu.itl.beans.AcercaDeBean.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", mx.edu.itl.beans.AcercaDeBean.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", mx.edu.itl.beans.AcercaDeBean.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", mx.edu.itl.beans.AcercaDeBean.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", mx.edu.itl.beans.AcercaDeBean.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", mx.edu.itl.beans.AcercaDeBean.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", mx.edu.itl.beans.AcercaDeBean.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", mx.edu.itl.beans.AcercaDeBean.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", mx.edu.itl.beans.AcercaDeBean.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", mx.edu.itl.beans.AcercaDeBean.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", mx.edu.itl.beans.AcercaDeBean.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_institucion] = new PropertyDescriptor ( "institucion", mx.edu.itl.beans.AcercaDeBean.class, "getInstitucion", "setInstitucion" ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", mx.edu.itl.beans.AcercaDeBean.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", mx.edu.itl.beans.AcercaDeBean.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", mx.edu.itl.beans.AcercaDeBean.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", mx.edu.itl.beans.AcercaDeBean.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", mx.edu.itl.beans.AcercaDeBean.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", mx.edu.itl.beans.AcercaDeBean.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_logo1] = new PropertyDescriptor ( "logo1", mx.edu.itl.beans.AcercaDeBean.class, "getLogo1", "setLogo1" ); // NOI18N
            properties[PROPERTY_logo1].setPreferred ( true );
            properties[PROPERTY_logo1].setDisplayName ( "Logotipo Institucional" );
            properties[PROPERTY_logo1].setShortDescription ( "Logo de la institución o universidad" );
            properties[PROPERTY_logo1Ajustado] = new PropertyDescriptor ( "logo1Ajustado", mx.edu.itl.beans.AcercaDeBean.class, "isLogo1Ajustado", "setLogo1Ajustado" ); // NOI18N
            properties[PROPERTY_logo1Ajustado].setPreferred ( true );
            properties[PROPERTY_logo1Ajustado].setDisplayName ( "Ajustar Logo Institucional" );
            properties[PROPERTY_logo1Ajustado].setShortDescription ( "Ajusta el logo institucional a las dimensiones del marco" );
            properties[PROPERTY_logo2] = new PropertyDescriptor ( "logo2", mx.edu.itl.beans.AcercaDeBean.class, "getLogo2", "setLogo2" ); // NOI18N
            properties[PROPERTY_logo2].setPreferred ( true );
            properties[PROPERTY_logo2].setDisplayName ( "Logo del Campus" );
            properties[PROPERTY_logo2].setShortDescription ( "Logo del campus al que pertenece la Universidad" );
            properties[PROPERTY_logo2Ajustado] = new PropertyDescriptor ( "logo2Ajustado", mx.edu.itl.beans.AcercaDeBean.class, "isLogo2Ajustado", "setLogo2Ajustado" ); // NOI18N
            properties[PROPERTY_logo2Ajustado].setPreferred ( true );
            properties[PROPERTY_logo2Ajustado].setDisplayName ( "Ajustar Logo del Campus" );
            properties[PROPERTY_logo2Ajustado].setShortDescription ( "Ajustar el logo del campus a las dimensiones del marco" );
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", mx.edu.itl.beans.AcercaDeBean.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_materia] = new PropertyDescriptor ( "materia", mx.edu.itl.beans.AcercaDeBean.class, "getMateria", "setMateria" ); // NOI18N
            properties[PROPERTY_materia].setPreferred ( true );
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", mx.edu.itl.beans.AcercaDeBean.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", mx.edu.itl.beans.AcercaDeBean.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", mx.edu.itl.beans.AcercaDeBean.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", mx.edu.itl.beans.AcercaDeBean.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", mx.edu.itl.beans.AcercaDeBean.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", mx.edu.itl.beans.AcercaDeBean.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", mx.edu.itl.beans.AcercaDeBean.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", mx.edu.itl.beans.AcercaDeBean.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", mx.edu.itl.beans.AcercaDeBean.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", mx.edu.itl.beans.AcercaDeBean.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_nombreApp] = new PropertyDescriptor ( "nombreApp", mx.edu.itl.beans.AcercaDeBean.class, "getNombreApp", "setNombreApp" ); // NOI18N
            properties[PROPERTY_nombreApp].setPreferred ( true );
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", mx.edu.itl.beans.AcercaDeBean.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", mx.edu.itl.beans.AcercaDeBean.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", mx.edu.itl.beans.AcercaDeBean.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", mx.edu.itl.beans.AcercaDeBean.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", mx.edu.itl.beans.AcercaDeBean.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", mx.edu.itl.beans.AcercaDeBean.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", mx.edu.itl.beans.AcercaDeBean.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", mx.edu.itl.beans.AcercaDeBean.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", mx.edu.itl.beans.AcercaDeBean.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", mx.edu.itl.beans.AcercaDeBean.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", mx.edu.itl.beans.AcercaDeBean.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", mx.edu.itl.beans.AcercaDeBean.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", mx.edu.itl.beans.AcercaDeBean.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", mx.edu.itl.beans.AcercaDeBean.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", mx.edu.itl.beans.AcercaDeBean.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", mx.edu.itl.beans.AcercaDeBean.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", mx.edu.itl.beans.AcercaDeBean.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", mx.edu.itl.beans.AcercaDeBean.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", mx.edu.itl.beans.AcercaDeBean.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", mx.edu.itl.beans.AcercaDeBean.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", mx.edu.itl.beans.AcercaDeBean.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", mx.edu.itl.beans.AcercaDeBean.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", mx.edu.itl.beans.AcercaDeBean.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", mx.edu.itl.beans.AcercaDeBean.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_versionApp] = new PropertyDescriptor ( "versionApp", mx.edu.itl.beans.AcercaDeBean.class, "getVersionApp", "setVersionApp" ); // NOI18N
            properties[PROPERTY_versionApp].setPreferred ( true );
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", mx.edu.itl.beans.AcercaDeBean.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mx.edu.itl.beans.AcercaDeBean.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", mx.edu.itl.beans.AcercaDeBean.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", mx.edu.itl.beans.AcercaDeBean.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", mx.edu.itl.beans.AcercaDeBean.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", mx.edu.itl.beans.AcercaDeBean.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.AcercaDeBean.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static String iconNameC16 = "/mx/edu/itl/util/AcercaDe_icon.jpg";//GEN-BEGIN:Icons
