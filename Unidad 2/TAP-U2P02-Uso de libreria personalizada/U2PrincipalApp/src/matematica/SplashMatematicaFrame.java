...
public class SplashMatematicaFrame extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MATEMATICA APP");

        jlblPorcBarraProgreso.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addGap(18, 18, 18)
                .addComponent(jlblPorcBarraProgreso, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void ejecutar() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashMatematicaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashMatematicaFrame().setVisible(true);
            }
        });
    }   
    ...
    private javax.swing.JLabel jlblPorcBarraProgreso;
    ...
    public void run() {        
        while ( tiempo != null){
            try {
                ...
                Logger.getLogger(SplashMatematicaFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }  
        tiempo = null;
    }                       
