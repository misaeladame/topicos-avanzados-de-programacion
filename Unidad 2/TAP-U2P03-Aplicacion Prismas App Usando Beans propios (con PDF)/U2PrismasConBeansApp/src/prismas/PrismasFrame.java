...
:*
:*                      Aplicación GUI para probar los Beans
:*        
:*  Archivo     : PrismasFrame.java
:*  Autor       : José Misael Adame Sandoval     18131209
:*  Fecha       : 3/Abr/2020
:*  Compilador  : JAVA J2SE v1.8.0
:*  Descripción : Aplicación que accede a las Beans JCilindro, JPrismaRectangular
:*                y JPrismaTriangular e invoca a cada uno de los métodos y 
:*                funcionalidades para realizar los cálculos correspondientes
:*                
:*  Ultima modif:
:*  Fecha       Modificó             Motivo
:*========================================================================================== 
:*  6/Abr/2020 Misael Adame         Agregar prólogo
:*------------------------------------------------------------------------------------------*/
...
public class PrismasFrame extends javax.swing.JFrame implements JValoresPrismasListener {
    ...
    public PrismasFrame ()  {
        ...
        jCilindro.addJCilindroListener ( this );
        jPrismaRectangular.addJPrismaRectangularListener ( this );
        jPrismaTriangular.addJPrismaTriangularListener ( this );
        
        jtxfCilindroRadio.setText ( jCilindro.getRadio () + "" );
        jtxfCilindroAltura.setText ( jCilindro.getAltura () + "" );
        
        jtxfPrismRectLargo.setText ( jPrismaRectangular.getLargo () + "" );
        jtxfPrismRectAncho.setText ( jPrismaRectangular.getAncho () + "" );
        jtxfPrismRectAltura.setText ( jPrismaRectangular.getAltura () + "" );
        
        jtxfPrismTriangCatetoA.setText ( jPrismaTriangular.getCateto_a () + "" );
        jtxfPrismTriangCatetoB.setText ( jPrismaTriangular.getCateto_b () + "" );
        jtxfPrismTriangAltura.setText ( jPrismaTriangular.getAltura () + "" );
    ...
    private void initComponents() {
        ...
        jCilindro = new mx.edu.itl.beans.JCilindro();
        ...
        jPrismaRectangular = new mx.edu.itl.beans.JPrismaRectangular();
        ...
        jPrismaTriangular = new mx.edu.itl.beans.JPrismaTriangular();
        ...
        jCilindro.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(38, 38, 38)
                .addComponent(jCilindro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPrismaTriangular.setBorder(javax.swing.BorderFactory.createEtchedBorder());
    ...
    private void jmniEdicionLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmniEdicionLimpiarActionPerformed
        ...
        jCilindro.setRadio ( 0 );
        jCilindro.setAltura ( 0 );
        
        jtxfPrismRectLargo.setText ( null );
        jtxfPrismRectAncho.setText ( null );
        jtxfPrismRectAltura.setText ( null );
        
        jPrismaRectangular.setLargo ( 0 );
        jPrismaRectangular.setAncho ( 0 );
        jPrismaRectangular.setAltura ( 0 );
              
        jtxfPrismTriangCatetoA.setText ( null );
        jtxfPrismTriangCatetoB.setText ( null );
        jtxfPrismTriangAltura.setText ( null );
        
        jPrismaTriangular.setCateto_a ( 0 );
        jPrismaTriangular.setCateto_b ( 0 );
        jPrismaTriangular.setAltura ( 0 );
    ...
    private void jbtnPrisRectCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPrisRectCalcularActionPerformed
        try {
            ...
            if ( largo < 0 || ancho < 0 || altura < 0 ) 
                ...
                jlblPrismRectAreaBase.setText ( jPrismaRectangular.areaBase () + "" );
                jlblPrismRectAreaLateral.setText ( jPrismaRectangular.areaLateral () + "" );                                                   
                jlblPrismRectAreaTotal.setText ( jPrismaRectangular.areaTotal () + "" );
                jlblPrismRectVolumen.setText ( jPrismaRectangular.volumen () + "" ); 
            }
    ...
    private void jbtnCilindroCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCilindroCalcularActionPerformed
        try {
            ...
            if ( radio < 0 || altura < 0 ) 
                ...
                jlblCilindroAreaBase.setText ( jCilindro.areaBase () + "" );
                jlblClilindroAreaLateral.setText ( jCilindro.areaLateral () + "" );
                jlblCilindroAreaTotal.setText ( jCilindro.areaTotal () + "" );
                jlblCilindroVolumen.setText ( jCilindro.volumen () + "" );   
            }
    ...
    private void jbtnPrismTriangCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPrismTriangCalcularActionPerformed
        try { 
            ...
            if ( cateto_a < 0 || cateto_b < 0 || altura < 0 ) 
                ...
                jlblPrismTriangAreaBase.setText ( jPrismaTriangular.areaBase () + "" );
                jlblPrismTriangAreaLateral.setText ( jPrismaTriangular.areaLateral () + "" );                                                   
                jlblPrismTriangAreaTotal.setText ( jPrismaTriangular.areaTotal () + "" );
                jlblPrismTriangVolumen.setText ( jPrismaTriangular.volumen () + "" );
            }
    ...
    private void jtxfPrismRectLargoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismRectLargoKeyReleased
        try {
            float largo = Float.parseFloat (jtxfPrismRectLargo.getText () );
            jPrismaRectangular.setLargo ( largo );
        } catch ( NumberFormatException ex ) {
            jPrismaRectangular.setLargo ( 0 );
        }
    ...
    private void jtxfPrismRectAnchoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismRectAnchoKeyReleased
        try {
            float ancho = Float.parseFloat (jtxfPrismRectAncho.getText() );   
            jPrismaRectangular.setAncho ( ancho );
        }  catch ( NumberFormatException ex ) {
            jPrismaRectangular.setAncho ( 0 );
        }
    ...
    private void jtxfPrismRectAlturaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismRectAlturaKeyReleased
        try {
            float altura = Float.parseFloat (jtxfPrismRectAltura.getText() ); 
            jPrismaRectangular.setAltura ( altura );
        } catch ( NumberFormatException ex ) {
            jPrismaRectangular.setAltura ( 0 );
        }
    ...
    private void jtxfPrismTriangCatetoBKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismTriangCatetoBKeyReleased
        try {
            float cateto_b = Float.parseFloat ( jtxfPrismTriangCatetoB.getText() );
            jPrismaTriangular.setCateto_b ( cateto_b);
        } catch ( NumberFormatException ex ) {
            jPrismaTriangular.setCateto_b ( 0 );
        }
    ...
    private void jtxfPrismTriangAlturaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismTriangAlturaKeyReleased
        try {
            float altura = Float.parseFloat ( jtxfPrismTriangAltura.getText() );
            jPrismaTriangular.setAltura(altura);
        } catch  ( NumberFormatException ex ) {
            jPrismaTriangular.setAltura ( 0 );
        }
    ...
    private void jtxfPrismTriangCatetoAKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxfPrismTriangCatetoAKeyReleased
        try {
            float cateto_a = Float.parseFloat ( jtxfPrismTriangCatetoA.getText() );
            jPrismaTriangular.setCateto_a ( cateto_a );
        } catch ( NumberFormatException ex ) {
            jPrismaTriangular.setCateto_a ( 0 );
        }
    ...
    private mx.edu.itl.beans.JCilindro jCilindro;
    ...
    private mx.edu.itl.beans.JPrismaRectangular jPrismaRectangular;
    private mx.edu.itl.beans.JPrismaTriangular jPrismaTriangular;
