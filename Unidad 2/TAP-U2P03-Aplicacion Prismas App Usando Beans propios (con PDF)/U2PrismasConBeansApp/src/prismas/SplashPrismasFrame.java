...
:*        
:*  Archivo     : SplashPrismasFrame.java
...
public class SplashPrismasFrame extends javax.swing.JFrame implements Runnable {
    ...
    public static void ejecutar() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashPrismasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashPrismasFrame().setVisible(true);
            }
        });
    }
    ...
    public void run() {
        ...
        while ( tiempo != null ) {
            try {
                ...
                Logger.getLogger(SplashPrismasFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }  
        tiempo = null;
    }                  
