...
:*
:*                           BeanInfo de un Prisma Rectangular
:*        
:*  Archivo     : JPrismaRectangularBeanInfo.java
:*  Autor       : José Misael Adame Sandoval     18131209
:*  Fecha       : 06/Abr/2020
:*  Compilador  : JAVA J2SE v1.8.0
:*  Descripción : BeanInfo que permite modificar propiedades del Bean
:*                JPrismaRectangular
:*                     
:*                
:*  Ultima modif:
...
public class JPrismaRectangularBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mx.edu.itl.beans.JPrismaRectangular.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_imagenPrismaRectangularAjustado = 49;
    ...
    private static final int PROPERTY_largo = 58;
    private static final int PROPERTY_layout = 59;
    private static final int PROPERTY_leyendaAltura = 60;
    private static final int PROPERTY_leyendaAncho = 61;
    private static final int PROPERTY_leyendaLargo = 62;
    ...
    private static final int PROPERTY_prismaRectangular = 86;
    ...
    private static final int PROPERTY_toolTipText = 94;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", mx.edu.itl.beans.JPrismaRectangular.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", mx.edu.itl.beans.JPrismaRectangular.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", mx.edu.itl.beans.JPrismaRectangular.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", mx.edu.itl.beans.JPrismaRectangular.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_altura] = new PropertyDescriptor ( "altura", mx.edu.itl.beans.JPrismaRectangular.class, "getAltura", "setAltura" ); // NOI18N
            properties[PROPERTY_altura].setPreferred ( true );
            properties[PROPERTY_altura].setDisplayName ( "Valor Altura" );
            properties[PROPERTY_altura].setShortDescription ( "Se determina el valor de la altura del Prisma Rectangular" );
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_ancho] = new PropertyDescriptor ( "ancho", mx.edu.itl.beans.JPrismaRectangular.class, "getAncho", "setAncho" ); // NOI18N
            properties[PROPERTY_ancho].setPreferred ( true );
            properties[PROPERTY_ancho].setDisplayName ( "Valor Ancho" );
            properties[PROPERTY_ancho].setShortDescription ( "Ancho del Prisma Rectangular" );
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", mx.edu.itl.beans.JPrismaRectangular.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", mx.edu.itl.beans.JPrismaRectangular.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", mx.edu.itl.beans.JPrismaRectangular.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", mx.edu.itl.beans.JPrismaRectangular.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", mx.edu.itl.beans.JPrismaRectangular.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", mx.edu.itl.beans.JPrismaRectangular.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", mx.edu.itl.beans.JPrismaRectangular.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", mx.edu.itl.beans.JPrismaRectangular.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", mx.edu.itl.beans.JPrismaRectangular.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", mx.edu.itl.beans.JPrismaRectangular.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", mx.edu.itl.beans.JPrismaRectangular.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", mx.edu.itl.beans.JPrismaRectangular.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", mx.edu.itl.beans.JPrismaRectangular.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", mx.edu.itl.beans.JPrismaRectangular.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", mx.edu.itl.beans.JPrismaRectangular.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", mx.edu.itl.beans.JPrismaRectangular.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", mx.edu.itl.beans.JPrismaRectangular.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", mx.edu.itl.beans.JPrismaRectangular.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", mx.edu.itl.beans.JPrismaRectangular.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", mx.edu.itl.beans.JPrismaRectangular.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", mx.edu.itl.beans.JPrismaRectangular.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", mx.edu.itl.beans.JPrismaRectangular.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", mx.edu.itl.beans.JPrismaRectangular.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", mx.edu.itl.beans.JPrismaRectangular.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", mx.edu.itl.beans.JPrismaRectangular.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", mx.edu.itl.beans.JPrismaRectangular.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", mx.edu.itl.beans.JPrismaRectangular.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", mx.edu.itl.beans.JPrismaRectangular.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", mx.edu.itl.beans.JPrismaRectangular.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", mx.edu.itl.beans.JPrismaRectangular.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", mx.edu.itl.beans.JPrismaRectangular.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", mx.edu.itl.beans.JPrismaRectangular.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_imagenPrismaRectangularAjustado] = new PropertyDescriptor ( "imagenPrismaRectangularAjustado", mx.edu.itl.beans.JPrismaRectangular.class, "isImagenPrismaRectangularAjustado", null ); // NOI18N
            properties[PROPERTY_imagenPrismaRectangularAjustado].setPreferred ( true );
            properties[PROPERTY_imagenPrismaRectangularAjustado].setDisplayName ( "Ajustar Imagen" );
            properties[PROPERTY_imagenPrismaRectangularAjustado].setShortDescription ( "Ajusta la imagen del Prisma Rectangular" );
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", mx.edu.itl.beans.JPrismaRectangular.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", mx.edu.itl.beans.JPrismaRectangular.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", mx.edu.itl.beans.JPrismaRectangular.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", mx.edu.itl.beans.JPrismaRectangular.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", mx.edu.itl.beans.JPrismaRectangular.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", mx.edu.itl.beans.JPrismaRectangular.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_largo] = new PropertyDescriptor ( "largo", mx.edu.itl.beans.JPrismaRectangular.class, "getLargo", "setLargo" ); // NOI18N
            properties[PROPERTY_largo].setPreferred ( true );
            properties[PROPERTY_largo].setDisplayName ( "Valor Largo" );
            properties[PROPERTY_largo].setShortDescription ( "Determina el Valor del Largo del Prisma Rectangular" );
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", mx.edu.itl.beans.JPrismaRectangular.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_leyendaAltura] = new PropertyDescriptor ( "leyendaAltura", mx.edu.itl.beans.JPrismaRectangular.class, "getLeyendaAltura", "setLeyendaAltura" ); // NOI18N
            properties[PROPERTY_leyendaAltura].setPreferred ( true );
            properties[PROPERTY_leyendaAltura].setDisplayName ( "Leyenda Altura" );
            properties[PROPERTY_leyendaAltura].setShortDescription ( "Permite modificar la Leyenda de la Altura" );
            properties[PROPERTY_leyendaAncho] = new PropertyDescriptor ( "leyendaAncho", mx.edu.itl.beans.JPrismaRectangular.class, "getLeyendaAncho", "setLeyendaAncho" ); // NOI18N
            properties[PROPERTY_leyendaAncho].setPreferred ( true );
            properties[PROPERTY_leyendaAncho].setDisplayName ( "Leyenda Ancho" );
            properties[PROPERTY_leyendaAncho].setShortDescription ( "Permite modificar la Leyenda del Ancho" );
            properties[PROPERTY_leyendaLargo] = new PropertyDescriptor ( "leyendaLargo", mx.edu.itl.beans.JPrismaRectangular.class, "getLeyendaLargo", "setLeyendaLargo" ); // NOI18N
            properties[PROPERTY_leyendaLargo].setPreferred ( true );
            properties[PROPERTY_leyendaLargo].setDisplayName ( "Leyenda Largo" );
            properties[PROPERTY_leyendaLargo].setShortDescription ( "Permite modificar la leyenda del Largo" );
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", mx.edu.itl.beans.JPrismaRectangular.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", mx.edu.itl.beans.JPrismaRectangular.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", mx.edu.itl.beans.JPrismaRectangular.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", mx.edu.itl.beans.JPrismaRectangular.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", mx.edu.itl.beans.JPrismaRectangular.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", mx.edu.itl.beans.JPrismaRectangular.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", mx.edu.itl.beans.JPrismaRectangular.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", mx.edu.itl.beans.JPrismaRectangular.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", mx.edu.itl.beans.JPrismaRectangular.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", mx.edu.itl.beans.JPrismaRectangular.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", mx.edu.itl.beans.JPrismaRectangular.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", mx.edu.itl.beans.JPrismaRectangular.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", mx.edu.itl.beans.JPrismaRectangular.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", mx.edu.itl.beans.JPrismaRectangular.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", mx.edu.itl.beans.JPrismaRectangular.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", mx.edu.itl.beans.JPrismaRectangular.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", mx.edu.itl.beans.JPrismaRectangular.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", mx.edu.itl.beans.JPrismaRectangular.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", mx.edu.itl.beans.JPrismaRectangular.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", mx.edu.itl.beans.JPrismaRectangular.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_prismaRectangular] = new PropertyDescriptor ( "prismaRectangular", mx.edu.itl.beans.JPrismaRectangular.class, "getPrismaRectangular", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", mx.edu.itl.beans.JPrismaRectangular.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", mx.edu.itl.beans.JPrismaRectangular.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", mx.edu.itl.beans.JPrismaRectangular.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", mx.edu.itl.beans.JPrismaRectangular.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", mx.edu.itl.beans.JPrismaRectangular.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", mx.edu.itl.beans.JPrismaRectangular.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", mx.edu.itl.beans.JPrismaRectangular.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", mx.edu.itl.beans.JPrismaRectangular.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", mx.edu.itl.beans.JPrismaRectangular.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", mx.edu.itl.beans.JPrismaRectangular.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", mx.edu.itl.beans.JPrismaRectangular.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", mx.edu.itl.beans.JPrismaRectangular.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", mx.edu.itl.beans.JPrismaRectangular.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", mx.edu.itl.beans.JPrismaRectangular.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", mx.edu.itl.beans.JPrismaRectangular.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", mx.edu.itl.beans.JPrismaRectangular.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mx.edu.itl.beans.JPrismaRectangular.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", mx.edu.itl.beans.JPrismaRectangular.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", mx.edu.itl.beans.JPrismaRectangular.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", mx.edu.itl.beans.JPrismaRectangular.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", mx.edu.itl.beans.JPrismaRectangular.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mx.edu.itl.beans.JPrismaRectangular.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_addJPrismaRectangularListener7 = 7;
    ...
    private static final int METHOD_fireJPrismaRectangularEvent36 = 36;
    ...
    private static final int METHOD_removeJPrismaRectangularListener116 = 116;
    ...
    private static final int METHOD_volumen150 = 150;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addJPrismaRectangularListener7] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("addJPrismaRectangularListener", new Class[] {mx.edu.itl.eventos.JValoresPrismasListener.class})); // NOI18N
            methods[METHOD_addJPrismaRectangularListener7].setDisplayName ( "" );
            ...
            methods[METHOD_areaBase11] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("areaBase", new Class[] {})); // NOI18N
            methods[METHOD_areaBase11].setDisplayName ( "" );
            methods[METHOD_areaLateral12] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("areaLateral", new Class[] {})); // NOI18N
            methods[METHOD_areaLateral12].setDisplayName ( "" );
            methods[METHOD_areaTotal13] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("areaTotal", new Class[] {})); // NOI18N
            ...
            methods[METHOD_fireJPrismaRectangularEvent36] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("fireJPrismaRectangularEvent", new Class[] {mx.edu.itl.eventos.JPrismaRectangularEvent.class})); // NOI18N
            methods[METHOD_fireJPrismaRectangularEvent36].setDisplayName ( "" );
            ...
            methods[METHOD_removeJPrismaRectangularListener116] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("removeJPrismaRectangularListener", new Class[] {mx.edu.itl.eventos.JValoresPrismasListener.class})); // NOI18N
            methods[METHOD_removeJPrismaRectangularListener116].setDisplayName ( "" );
            ...
            methods[METHOD_update147] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("update", new Class[] {})); // NOI18N
            ...
            methods[METHOD_volumen150] = new MethodDescriptor(mx.edu.itl.beans.JPrismaRectangular.class.getMethod("volumen", new Class[] {})); // NOI18N
            methods[METHOD_volumen150].setDisplayName ( "" );
        }
    ...
    private static String iconNameC16 = "/mx/edu/itl/util/PrismaRectangular_icon.jpg";//GEN-BEGIN:Icons
